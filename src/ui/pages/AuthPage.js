...
export class AuthPage {
  ...
  renderForm() {
    ...
    googleBtn.addEventListener('click', async () => {
      ...
      const { data, error, isRedirect } = await signInWithGoogle();
      if (error) {
      ...
      // For OAuth redirects, the browser navigates away to Google.
      // Session is picked up by onAuthStateChange when it returns.
